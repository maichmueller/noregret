function(register_nor_target target_name)
  ...
  set(REGISTERED_TARGET_NAMES_LIST
      ${REGISTERED_TARGET_NAMES_LIST}
      PARENT_SCOPE)
  set(REGISTERED_TEST_SOURCES_LIST
...
function(
  ...
  set_target_properties(
    ${target_name} PROPERTIES EXCLUDE_FROM_ALL True # don't build tests when ALL is asked to be built. Only on demand.
  )
