...
if(SKBUILD)
  ...
  install(FILES "${PROJECT_BINARY_DIR}/${PROJECT_NAME_LOWERCASE}ConfigVersion.cmake"
                "${PROJECT_BINARY_DIR}/${PROJECT_NAME_LOWERCASE}Config.cmake"
          DESTINATION ${CMAKE_INSTALL_LIBDIR}/${PROJECT_NAME_LOWERCASE}/cmake/)
  # this installation assumes that the project has an eponymous include directory for the project c++ library we install
  # that sub-directory instead of PROJECT_nor_INCLUDE_DIR, in order to avoid an include/include/proj_name situation and
  # get the correct include/proj_name.
