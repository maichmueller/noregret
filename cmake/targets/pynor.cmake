...
pybind11_add_module(${nor_pymodule} MODULE ${_pynor_exclude_from_all} ${LIBRARY_SOURCES} ${PYTHON_MODULE_SOURCES})

set_target_properties(${nor_pymodule} PROPERTIES
        LIBRARY_OUTPUT_NAME _${nor_pymodule}
