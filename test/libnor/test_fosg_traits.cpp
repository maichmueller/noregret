...
{
   EXPECT_TRUE((std::is_same_v< nor::auto_action_type< dummy::Traits >, int >) );
   EXPECT_TRUE((std::is_same_v< nor::auto_info_state_type< dummy::Traits >, std::string >) );

   EXPECT_TRUE((std::is_same_v< nor::auto_world_state_type< dummy::Traits >, std::size_t >) );
   EXPECT_TRUE((std::is_same_v< nor::auto_public_state_type< dummy::Traits >, void >) );

   EXPECT_TRUE((std::is_same_v< nor::auto_public_state_type< dummy::Env >, dummy::Publicstate >) );
}
